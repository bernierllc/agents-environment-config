...
Testids are a **development artifact**, parallel to ARIA labels — both are added when a component is built, not retroactively when tests fail.

### Required Elements (add `data-testid` at build time)
...
```tsx
// ✅ GOOD - testid alongside ARIA label
<button
...
// ✅ GOOD - testid on dynamic state container
{hasError && (
  <div
    id="email-error"
...
- [ ] All interactive/dynamic/landmark elements have `data-testid`
