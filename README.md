...
To add support for a new git provider (GitLab, Bitbucket, etc.), see [docs/contributors/adding-git-provider-support.md](docs/contributors/adding-git-provider-support.md).
...
8. Runs the **git essentials phase**: detects your git provider (GitHub), diffs missing essentials, and offers to create them (see [Git Essentials](#git-essentials))
